...
<div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-car"></i> Voitures</span>
              <div class="count">123.50</div>
              <span class="count_bottom"><i class="blue"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-file-text"></i> Contrats</span>
              <div class="count">2,500</div>
              <span class="count_bottom"><i class="blue"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-usd"></i> Encaissements</span>
              <div class="count">4,567</div>
              <span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>12% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-krw"></i> Charges</span>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 bg-white">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-6">
                    ...
                    <div>
                      ...
                      <div class="">
                        <div class="progress progress_sm" style="width: 76%;">
                          <div class="progress-bar bg-gris" role="progressbar" data-transitiongoal="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      $(document).ready(function() {
        ...
        $("#canvas_dahs").length && $.plot($("#canvas_dahs"), [
          ...
          colors: ["rgba(254, 90, 49, 0.38)", "rgba(102, 102, 102, 0.38)"],
          xaxis: {
